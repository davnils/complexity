...
By a simulation argument (TODO: REF) it holds that $\textsc{W[P]} \subseteq \XP$.
...
Hence the number of injective homomorphisms extending a candidate $\phi$ is $\Delta_\phi(f_\phi, g_\phi, h_\phi)$ (TODO: Ref Grohe).
