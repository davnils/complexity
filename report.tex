...
D{\'{\i}}az~{\em et al.}~\cite{DST02} introduced an algorithm for computing the number of homomorphisms $hom_{\phi}(P, H)$ in time $O^*(|H|^{|P|})$.
...
\Procedure{CountHomomorphisms}{$P,H,\phi$}\Comment{Count the number of homomorphisms mapping P onto H, extending $\phi$}

\State $\texttt{ordering} \gets \Call{GenerateStingyOrdering}{P}$
