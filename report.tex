...
This alternative view of complexity theory also forms natural ties with approximation algorithms, something which is studied in section \ref{sec:approx}.
...
For example it is relatively easy to construct circuits for \textsc{p-independent set} and \textsc{p-dominating set}, proving that they are contained in $W[1]$ and $W[2]$ respectively \cite{FG06}.
...
This chapter covers an implementation of \emph{counting thin subgraphs} \cite{BHKK13}.
