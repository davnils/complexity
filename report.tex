...
% TODO: Give an example kernelization and derive the FPT algorithm for some well-known problem
% (1) Derive kernelization of 3CNF-SAT where the parameterization is the number of variables
% (2) Describe how to use this result in order to show 3CNF-SAT \in FPT (w.r.t parameterization)
%     and the corresponding fpt-algorithm.
% parameterization: number of tuples => [<= 2^(3k)] running time
% still useful to locate a parameterization? .
